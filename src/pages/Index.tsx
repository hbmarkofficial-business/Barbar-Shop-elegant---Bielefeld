  ...
  return (
    <>
      <Helmet>
        ...
        <title>Barbershop Bielefeld | Barbar Shop Elegant</title>
        <meta
          name="description"
          content="Besuche unseren Premium Barbershop Barbar Shop Elegant in Bielefeld für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="Barbar Shop Elegant | Premium Barbershop Bielefeld" />
        <meta
        ...
        <meta name="twitter:title" content="Barbar Shop Elegant | Premium Barbershop Bielefeld" />
        <meta
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "sameAs": [
              "https://www.facebook.com/barbarshopelegant",
              "https://www.instagram.com/barbarshopelegant"
            ]
          })}
        </script>
      </Helmet>
