          ...
          <AnimateOnScroll animation="slide-right">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Heeper Str. 206, 33607 Bielefeld
                  </p>
                </div>
              </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button variant="goldOutline" size="xl" asChild>
                <a href="tel:017670151701">Jetzt anrufen</a>
              </Button>
            </div>
          </AnimateOnScroll>
          ...
          <AnimateOnScroll animation="slide-left">
            <div className="relative">
              <div className="aspect-square lg:aspect-[4/5] rounded-sm overflow-hidden border border-border">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d19641.818176793724!2d8.53716533476561!3d52.020957239288!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47ba3d2a12ce89f7%3A0xa028ab081eb96736!2sBarbar%20Shop%20elegant%20-%20Bielefeld!5e0!3m2!1sde!2sde!4v1771501254099!5m2!1sde!2sde"
                  width="100%"
                  height="100%"
                  ...
                  title="Standort Top Salon – Bielefeld"
                />
              </div>
